...
def upgrade() -> None:
    ...
    users = [
        {'id': uuid.uuid4(), 'email': 'alice@techcorp.com', 'username': 'alice', 'first_name': 'Alice', 'last_name': 'Johnson', 'hashed_password': 'hashedpassword', 'is_active': True, 'is_admin': False, 'company_id': companies[0]['id'], 'created_at': datetime.now(timezone.utc), 'updated_at': datetime.now(timezone.utc)},
        {'id': uuid.uuid4(), 'email': 'bob@techcorp.com', 'username': 'bob', 'first_name': 'Bob', 'last_name': 'Smith', 'hashed_password': 'hashedpassword', 'is_active': True, 'is_admin': True, 'company_id': companies[0]['id'], 'created_at': datetime.now(timezone.utc), 'updated_at': datetime.now(timezone.utc)},
        {'id': uuid.uuid4(), 'email': 'carol@innovate.com', 'username': 'carol', 'first_name': 'Carol', 'last_name': 'Williams', 'hashed_password': 'hashedpassword', 'is_active': True, 'is_admin': False, 'company_id': companies[1]['id'], 'created_at': datetime.now(timezone.utc), 'updated_at': datetime.now(timezone.utc)},
        {'id': uuid.uuid4(), 'email': 'dave@innovate.com', 'username': 'dave', 'first_name': 'Dave', 'last_name': 'Brown', 'hashed_password': 'hashedpassword', 'is_active': True, 'is_admin': True, 'company_id': companies[1]['id'], 'created_at': datetime.now(timezone.utc), 'updated_at': datetime.now(timezone.utc)},
        {'id': uuid.uuid4(), 'email': 'eve@greensolutions.com', 'username': 'eve', 'first_name': 'Eve', 'last_name': 'Davis', 'hashed_password': 'hashedpassword', 'is_active': True, 'is_admin': False, 'company_id': companies[2]['id'], 'created_at': datetime.now(timezone.utc), 'updated_at': datetime.now(timezone.utc)},
        {'id': uuid.uuid4(), 'email': 'frank@greensolutions.com', 'username': 'frank', 'first_name': 'Frank', 'last_name': 'Miller', 'hashed_password': 'hashedpassword', 'is_active': True, 'is_admin': True, 'company_id': companies[2]['id'], 'created_at': datetime.now(timezone.utc), 'updated_at': datetime.now(timezone.utc)},
        {'id': uuid.uuid4(), 'email': 'grace@fintech.com', 'username': 'grace', 'first_name': 'Grace', 'last_name': 'Wilson', 'hashed_password': 'hashedpassword', 'is_active': True, 'is_admin': False, 'company_id': companies[3]['id'], 'created_at': datetime.now(timezone.utc), 'updated_at': datetime.now(timezone.utc)},
        {'id': uuid.uuid4(), 'email': 'heidi@fintech.com', 'username': 'heidi', 'first_name': 'Heidi', 'last_name': 'Moore', 'hashed_password': 'hashedpassword', 'is_active': True, 'is_admin': True, 'company_id': companies[3]['id'], 'created_at': datetime.now(timezone.utc), 'updated_at': datetime.now(timezone.utc)},
        {'id': uuid.uuid4(), 'email': 'ivan@healthplus.com', 'username': 'ivan', 'first_name': 'Ivan', 'last_name': 'Taylor', 'hashed_password': 'hashedpassword', 'is_active': True, 'is_admin': False, 'company_id': companies[4]['id'], 'created_at': datetime.now(timezone.utc), 'updated_at': datetime.now(timezone.utc)},
        {'id': uuid.uuid4(), 'email': 'judy@healthplus.com', 'username': 'judy', 'first_name': 'Judy', 'last_name': 'Anderson', 'hashed_password': 'hashedpassword', 'is_active': True, 'is_admin': True, 'company_id': companies[4]['id'], 'created_at': datetime.now(timezone.utc), 'updated_at': datetime.now(timezone.utc)}
    ]
    tasks = [
